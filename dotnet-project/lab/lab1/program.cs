...
Security - Rs. 70000");
Console. Write(" Select the Department(1-3) : "); int ch=int. Parse(Console. ReadLine()); switch(ch){
...
{
if(percentage>=95) scholarship=courseFee;
 
else if(percentage>=85) scholarship=courseFee*0. 5; else if(percentage>=75) scholarship=courseFee*0. 25; else scholarship=0;
}

public void DisplayReceipt()
{
Console. WriteLine("\n===== UNIVERSITY ADMISSION RECEIPT =====");
Console. WriteLine(" Student : " +name); Console. WriteLine(" Course : " +course) ; Console. WriteLine(" Fee	: " +courseFee) ; Console. WriteLine(" Scholar : " +scholarship) ;
